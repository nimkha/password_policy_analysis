...
parser.add_argument("length", help="Specify min length of password. Must be between 4 - 20 characters", type=int)
...
if 4 <= args.length <= 20:
    main.run(args.file, args.length, args.uppercase, args.lowercase, args.special, args.digit, args.all, args.startUendD)
else:
